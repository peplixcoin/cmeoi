...
import { Star, FileText, Clock, Package, ShoppingBag, CreditCard, MessageSquare } from "lucide-react";
...
export default function OnlineOrderPage() {
  ...
  const getOrderStatusLabel = (status: string) => {
    switch (status) {
      ...
      case 'approved': return 'Way to deliver';
    ...
    <div className="min-h-screen py-4 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl px-6 py-2 mb-4 shadow-lg">
            <h1 className="text-base text-center font-bold text-white ">Online Orders</h1>
          </div>
